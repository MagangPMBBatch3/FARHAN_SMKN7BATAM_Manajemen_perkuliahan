        ...
        <div class="bg-white rounded-xl shadow-lg w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h2 class="text-xl font-semibold text-gray-800">Edit Data Dosen</h2>
                ...
                <form id="formEditDosen" onsubmit="updateDosen(); return false;">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label for="editNidn" class="block text-sm font-medium text-gray-700 mb-1.5">
                                    NIDN <span class="text-red-500">*</span>
                                </label>
                                <input type="text" id="editNidn" 
                            ...
                            <div>
                                <label for="editNip" class="block text-sm font-medium text-gray-700 mb-1.5">NIP</label>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label for="editGelarDepan" class="block text-sm font-medium text-gray-700 mb-1.5">Gelar Depan</label>
                                <input type="text" id="editGelarDepan" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                                    placeholder="Dr., Prof., dll">
                            </div>
                            <div>
                                <label for="editGelarBelakang" class="block text-sm font-medium text-gray-700 mb-1.5">Gelar Belakang</label>
                                <input type="text" id="editGelarBelakang" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="editStatusKepegawaian" class="block text-sm font-medium text-gray-700 mb-1.5">
                                    Status Kepegawaian <span class="text-red-500">*</span>
                                </label>
                                <select id="editStatusKepegawaian" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                                    required>
                                    <option value="">Pilih</option>
                            ...
                            <div>
                                <label for="editJabatan" class="block text-sm font-medium text-gray-700 mb-1.5">Jabatan</label>
            ...
            <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit" form="formEditDosen"
