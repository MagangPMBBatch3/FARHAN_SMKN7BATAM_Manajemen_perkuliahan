        ...
        <div class="bg-white rounded-xl shadow-lg w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h2 class="text-xl font-semibold text-gray-800">Tambah Bobot Nilai</h2>
            ...
            <div class="flex-1 overflow-y-auto px-6 py-6">
                <form id="formAddBobotNilai" onsubmit="createBobotNilai(); return false;">
                    @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="addMataKuliah" name="mata_kuliah_id"
                        ...
                        <div>
                            ...
                            <select id="addSemester" name="semester_id"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                                required>
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="addTugas" name="tugas" 
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                                        step="0.01"
                                        min="0"
                                        max="100"
                                        value="20"
                                        oninput="calculateTotalBobot('add')"
                                        required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" id="addQuiz" name="quiz" 
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                                        step="0.01"
                                        min="0"
                                        max="100"
                                ...
                                <div>
                                    ...
                                    <input type="number" id="addUTS" name="uts" 
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                                        step="0.01"
                                        min="0"
                                        max="100"
                                ...
                                <div>
                                    ...
                                    <input type="number" id="addUAS" name="uas" 
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                                        step="0.01"
                                        min="0"
                                        max="100"
                                ...
                                <div>
                                    ...
                                    <input type="number" id="addKehadiran" name="kehadiran" 
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                                        step="0.01"
                                        min="0"
                                        max="100"
                                ...
                                <div>
                                    ...
                                    <input type="number" id="addPraktikum" name="praktikum" 
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                                        step="0.01"
                                        min="0"
                                        max="100"
                            ...
                            <div class="mt-4 pt-4 border-t border-blue-200">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span id="addTotalBobot" class="text-lg font-bold text-green-600">100.00%</span>
                                </div>
            ...
            <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit" form="formAddBobotNilai"
