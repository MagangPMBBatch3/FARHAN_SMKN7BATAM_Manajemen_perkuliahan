        ...
        <div class="bg-white rounded-xl shadow-lg w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <form id="formEditSemester" onsubmit="updateSemester(); return false;">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="editSemester" name="nama" 
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                                required>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="editTahun" class="block text-sm font-medium text-gray-700 mb-1.5">
                                    Tahun Ajaran <span class="text-red-500">*</span>
                                </label>
                                <input type="text" id="editTahun" name="tahun" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                            ...
                            <div>
                                <label for="editPeriode" class="block text-sm font-medium text-gray-700 mb-1.5">
                                    Periode <span class="text-red-500">*</span>
                                </label>
                                <select id="editPeriode" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                                    required>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" id="editMulai" name="mulai" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                                    required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" id="editSelesai" name="selesai" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                                    required>
                            </div>
                        </div>
            ...
            <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit" form="formEditSemester"
