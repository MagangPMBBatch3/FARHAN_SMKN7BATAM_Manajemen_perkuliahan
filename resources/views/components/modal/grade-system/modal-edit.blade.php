        ...
        <div class="bg-white rounded-xl shadow-lg w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h2 class="text-xl font-semibold text-gray-800">Edit Grade System</h2>
            ...
            <div class="flex-1 overflow-y-auto px-6 py-6">
                <form id="formEditGradeSystem" onsubmit="updateGradeSystem(); return false;">
                    <input type="hidden" id="editId" name="id">
                    
                    <div class="space-y-4">
                        <div>
                            <label for="editGrade" class="block text-sm font-medium text-gray-700 mb-1.5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="editMinScore" class="block text-sm font-medium text-gray-700 mb-1.5">
                                    Nilai Minimal <span class="text-red-500">*</span>
                                </label>
                                <input type="number" id="editMinScore" name="min_score" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                                    step="0.01"
                                    min="0"
                                    max="100"
                            ...
                            <div>
                                <label for="editMaxScore" class="block text-sm font-medium text-gray-700 mb-1.5">
                        ...
                        <div>
                            <label for="editGradePoint" class="block text-sm font-medium text-gray-700 mb-1.5">
                                Grade Point (Bobot) <span class="text-red-500">*</span>
                            </label>
                            <input type="number" id="editGradePoint" name="grade_point" 
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                                step="0.01"
                                min="0"
                                max="4"
                        ...
                        <div>
                            <label for="editStatusKelulusan" class="block text-sm font-medium text-gray-700 mb-1.5">
                                Status Kelulusan <span class="text-red-500">*</span>
                            </label>
                            <select id="editStatusKelulusan" name="status_kelulusan"
    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
    required>
    ...
    <option value="Tidak Lulus">Tidak Lulus</option>
            ...
            <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit" form="formEditGradeSystem"
