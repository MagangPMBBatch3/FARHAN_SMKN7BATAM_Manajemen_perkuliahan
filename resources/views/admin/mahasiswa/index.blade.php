<x-layouts.dashboard title="Data Mahasiswa">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Angkatan</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">JK</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Semester</th>
                        ...
                        <tbody id="dataMahasiswa" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
            ...
            <div id="tableArsip" class="p-6 hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="dataMahasiswaArsip" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
    ...
    {{-- Script --}}
    <script src="{{ asset('js/admin/mahasiswa/mahasiswa.js') }}"></script>
    <script src="{{ asset('js/admin/mahasiswa/mahasiswa-create.js') }}"></script>
    <script src="{{ asset('js/admin/mahasiswa/mahasiswa-edit.js') }}"></script>
