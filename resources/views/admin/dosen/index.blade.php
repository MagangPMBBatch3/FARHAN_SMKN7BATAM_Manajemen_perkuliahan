<x-layouts.dashboard title="Data Dosen">
    <div class="space-y-6">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="relative flex-1 max-w-md">
                        ...
                        <input type="text" id="search" 
                            placeholder="Cari NIDN, Nama, atau Jurusan..." 
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status Kepegawaian</th>
                        ...
                        <tbody id="dataDosen" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
            ...
            <div id="tableArsip" class="p-6 hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="dosenArsip" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
    ...
    {{-- Modal --}}
    @include('components.modal.dosen.modal-add')
    @include('components.modal.dosen.modal-edit')

    {{-- Script --}}
    <script src="{{ asset('js/admin/dosen/dosen-edit.js') }}"></script>
    <script src="{{ asset('js/admin/dosen/dosen-create.js') }}"></script>
    <script src="{{ asset('js/admin/dosen/dosen.js') }}"></script>
