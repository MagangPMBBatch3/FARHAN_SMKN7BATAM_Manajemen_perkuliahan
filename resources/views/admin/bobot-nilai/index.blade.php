<x-layouts.dashboard title="Bobot Nilai">
    <div class="space-y-6">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="p-6 border-b border-gray-200">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
                    <div class="relative flex-1 max-w-md">
                        ...
                        <input type="text" id="search" 
                            placeholder="Cari mata kuliah atau keterangan..." 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label for="filterMataKuliah" class="block text-sm font-medium text-gray-700 mb-1.5">
                            Filter Mata Kuliah
                        </label>
                        <select id="filterMataKuliah" 
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            onchange="searchBobotNilai()">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Praktikum</th>
                        ...
                        <tbody id="dataBobotNilai" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <select id="perPage"
                                ...
                                onchange="loadBobotNilaiData(1, 1)">
            ...
            <div id="tableArsip" class="p-6 hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="dataBobotNilaiArsip" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
    ...
    <!-- Modals -->
    @include('components.modal.bobot-nilai.modal-add')
    @include('components.modal.bobot-nilai.modal-edit')

    <!-- Scripts -->
    <script src="{{ asset('js/admin/bobot-nilai/bobot-nilai.js') }}"></script>
    <script src="{{ asset('js/admin/bobot-nilai/bobot-nilai-create.js') }}"></script>
    <script src="{{ asset('js/admin/bobot-nilai/bobot-nilai-edit.js') }}"></script>
