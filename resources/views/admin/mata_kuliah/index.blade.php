<x-layouts.dashboard title="Data Mata Kuliah">
    <div class="space-y-6">
        {{-- Main Content --}}
            ...
            <div id="tableAktif" class="p-6">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="dataMataKuliah" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <select id="perPage"
                                ...
                                onchange="loadMataKuliahData(1, 1)">
            ...
            <div id="tableArsip" class="p-6 hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="dataMataKuliahArsip" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
    ...
    {{-- Modal --}}
    @include('components.modal.mata_kuliah.modal-add')
    @include('components.modal.mata_kuliah.modal-edit')

    {{-- Script --}}
    <script src="{{ asset('js/admin/mata_kuliah/mata_kuliah.js') }}"></script>
    <script src="{{ asset('js/admin/mata_kuliah/mata_kuliah-create.js') }}"></script>
    <script src="{{ asset('js/admin/mata_kuliah/mata_kuliah-edit.js') }}"></script>
