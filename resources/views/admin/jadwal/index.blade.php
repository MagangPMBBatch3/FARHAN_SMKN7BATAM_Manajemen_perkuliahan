<x-layouts.dashboard title="Data Jadwal Kuliah">
    <div class="space-y-6">
        {{-- Main Content --}}
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Jam Mulai</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Jam Selesai</th>
                        ...
                        <tbody id="dataJadwal" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
            ...
            <div id="tableArsip" class="p-6 hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="dataJadwalArsip" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
    ...
    {{-- Script --}}
    <script src="{{ asset('js/admin/jadwal/jadwal.js') }}"></script>
    <script src="{{ asset('js/admin/jadwal/jadwal-create.js') }}"></script>
    <script src="{{ asset('js/admin/jadwal/jadwal-edit.js') }}"></script>
