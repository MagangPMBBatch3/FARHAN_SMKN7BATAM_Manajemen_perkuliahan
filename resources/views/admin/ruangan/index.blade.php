<x-layouts.dashboard title="Data Ruangan">
    <div class="space-y-6">
        {{-- Main Content --}}
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Lantai</th>
                                ...
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Fasilitas</th>
                                <th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Aksi</th>
                            </tr>
                        </thead>
                        <tbody id="dataRuangan" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
            ...
            <div id="tableArsip" class="p-6 hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="dataRuanganArsip" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
    ...
    {{-- Modal --}}
    @include('components.modal.ruangan.modal-add')
    @include('components.modal.ruangan.modal-edit')

    {{-- Script --}}
    <script src="{{ asset('js/admin/ruangan/ruangan.js') }}"></script>
    <script src="{{ asset('js/admin/ruangan/ruangan-create.js') }}"></script>
    <script src="{{ asset('js/admin/ruangan/ruangan-edit.js') }}"></script>
