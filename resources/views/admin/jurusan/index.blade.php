<x-layouts.dashboard title="Data Jurusan">
    <div class="space-y-6">
        {{-- Main Content --}}
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Kode Jurusan</th>
                                ...
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Jenjang</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Akreditasi</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Kaprodi</th>
                                <th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Aksi</th>
                            </tr>
                        </thead>
                        <tbody id="dataJurusan" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Kode Jurusan</th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nama Jurusan</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Fakultas</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Jenjang</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Akreditasi</th>
                                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Kaprodi</th>
                                <th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Aksi</th>
                        ...
                        <tbody id="dataJurusanArsip" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
    ...
    {{-- Modal --}}
    @include('components.modal.jurusan.modal-add')
    @include('components.modal.jurusan.modal-edit')

    {{-- Script --}}
    <script src="{{ asset('js/admin/jurusan/jurusan.js') }}"></script>
    <script src="{{ asset('js/admin/jurusan/jurusan-create.js') }}"></script>
    <script src="{{ asset('js/admin/jurusan/jurusan-edit.js') }}"></script>
    ...
    <script>
        function showTab(tab) {
            ...
            loadlJurusanData(currentPageAktif, currentPageArsip);
        }
    </script>
</x-layouts.dashboard>