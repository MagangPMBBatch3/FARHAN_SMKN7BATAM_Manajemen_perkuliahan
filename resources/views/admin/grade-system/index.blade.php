<x-layouts.dashboard title="Sistem Penilaian (Grade System)">
    <div class="space-y-6">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nilai Min</th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nilai Max</th>
                        ...
                        <tbody id="dataGradeSystem" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <select id="perPage"
                                ...
                                onchange="loadGradeSystemData(1, 1)">
            ...
            <div id="tableArsip" class="p-6 hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="dataGradeSystemArsip" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
    ...
    <!-- Modals -->
    @include('components.modal.grade-system.modal-add')
