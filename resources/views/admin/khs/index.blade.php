<x-layouts.dashboard title="Data KHS">
    <div class="space-y-6">
        {{-- Main Content --}}
            ...
            <div id="tableAktif" class="p-6">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="dataKhs" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
            ...
            <div id="tableArsip" class="p-6 hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="dataKhsArsip" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
