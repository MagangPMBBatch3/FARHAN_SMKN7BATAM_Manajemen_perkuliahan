<x-layouts.dashboard title="Data Kelas">
            ...
            <div class="p-6 border-b border-gray-200">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="relative flex-1 max-w-md">
                        ...
                        <input type="text" id="search" placeholder="Cari NIM, Nama, atau Jurusan..."
            ...
            <div id="tableAktif" class="p-6">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="dataKelas" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
                        ...
                        <div>
                            <p id="pageInfoAktif" class="text-sm text-gray-700">
                                Menampilkan <span class="font-medium">1</span> sampai <span
                                    class="font-medium">10</span> dari <span class="font-medium">0</span> hasil
                            </p>
                        </div>
            ...
            <div id="tableArsip" class="p-6 hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="dataKelasArsip" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
    ...
    {{-- Script --}}
    <script src="{{ asset('js/admin/kelas/kelas.js') }}"></script>
    <script src="{{ asset('js/admin/kelas/kelas-create.js') }}"></script>
