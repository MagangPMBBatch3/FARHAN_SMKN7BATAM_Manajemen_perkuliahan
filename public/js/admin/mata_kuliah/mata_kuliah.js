    ...
    matakuliah.forEach(item => {
        ...
        if (isActive) {
            actions = `
                <div class="flex items-center justify-end gap-2">
                    <button onclick="openEditModal(${item.id}, '${item.kode_mk}', '${item.nama_mk}', '${item.jurusan?.nama_jurusan}', ${item.sks}, ${item.semester_rekomendasi}, '${item.jenis}', '${item.deskripsi}')" 
                    ...
                    <button onclick="hapusMataKuliah(${item.id})" 
            ...
            actions = `
                <div class="flex items-center justify-end gap-2">
                    <button onclick="restoreMataKuliah(${item.id})" 
                    ...
                    <button onclick="forceDeleteMataKuliah(${item.id})" 
        ...
        tbody.innerHTML += `
            <tr class="hover:bg-gray-50 transition-colors">
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${item.kode_mk}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${item.nama_mk}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${item.jurusan?.nama_jurusan || "-"}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${item.sks}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${item.semester_rekomendasi}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${item.jenis}</td>
