    ...
    semester.forEach(item => {
        ...
        if (isActive) {
            actions = `
                <div class="flex items-center justify-end gap-2">
                    <button onclick="openEditModal(${item.id}, '${item.kode_semester}', '${item.nama_semester}', '${item.tahun_ajaran}', '${item.periode}', '${item.tanggal_mulai}', '${item.tanggal_selesai}')" 
                    ...
                    <button onclick="hapusSemester(${item.id})" 
            ...
            actions = `
                <div class="flex items-center justify-end gap-2">
                    <button onclick="restoreSemester(${item.id})" 
                    ...
                    <button onclick="forceDeleteSemester(${item.id})" 
        ...
        tbody.innerHTML += `
            <tr class="hover:bg-gray-50 transition-colors">
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${item.kode_semester}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${item.nama_semester}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${item.tahun_ajaran || "-"}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${item.periode}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${item.tanggal_mulai}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${item.tanggal_selesai}</td>
